...
#### `eotwash_prl2016_digitized_contract.csv` (To Be Created)
- **Source:** Eöt-Wash Group / Tan et al. PRL 116, 131102 (2016)
- **Type:** Digitized from published plot
- **Range:** Millimeter-centimeter scale (λ ≈ 10⁻⁴ → 10⁻² m)
- **Purpose:** **Critical for mm-cm hunt band analysis**
- **Status:** Requires manual digitization
