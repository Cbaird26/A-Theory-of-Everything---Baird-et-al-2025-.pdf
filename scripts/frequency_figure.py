...
Outputs:
  - results/frequency_atlas.png
  - results/frequency_atlas.pdf
...
# Import conversion functions from frequency_atlas
from scripts.frequency_atlas import length_to_freq_yukawa, H_PLANCK, E_CHARGE, C_LIGHT

# Physical constants (exact SI definitions)
C = C_LIGHT  # m/s
H = H_PLANCK  # J s
E_CHARGE_CONST = E_CHARGE  # J / eV
...
def main() -> None:
    ...
    png_path = "results/frequency_atlas.png"
    pdf_path = "results/frequency_atlas.pdf"
